...
- **Catgirl Resource Machine** (November 2025) — C++/Qt 6 programming puzzle game with assembly-like instruction set and 4-level campaign (Fundamentals of Programming, Grade: 100/100, A+, 4.0/4.0)
- **Home Service Robot Vision Pipeline (YOLO11-seg + SAM3)** (June 2026) — Full-stack deep learning pipeline for household object detection and instance segmentation (Introduction to AI, Grade: 4.0/4.0)
