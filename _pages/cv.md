...
Education
======
* **B.Eng. in Automation**, School of Information Science and Technology, Tsinghua University (August 2025 -- Present)
  * GPA: 3.94/4.00
...
* **Programming & Tools:** Python, C/C++, PyTorch

Research Interest
======
* **Embodied AI:** Robot Learning (RL, Imitation Learning, Sim-to-Real Transfer), Manipulation & Locomotion, Human-Robot Interaction, Physics Simulation & Digital Twins
...
Projects
======
* **Critical Path Method Project Scheduler** (July 2026, In Progress) — C++ project scheduling system with MVC architecture and CPM algorithm (Object-Oriented Programming Training)
* **Catgirl Resource Machine** (November 2025) — C++/Qt 6 puzzle game with assembly-like instruction set and 4-level campaign (Fundamentals of Programming, **Grade: 100/100, A+, 4.0/4.0**)
* **Home Service Robot Vision Pipeline (YOLO11-seg + SAM3)** (June 2026) — Full-stack DL pipeline for household object detection and instance segmentation, SAM3 + YOLO11-seg + React frontend (Introduction to AI, **Grade: 4.0/4.0**)
